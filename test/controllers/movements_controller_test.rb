...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { category: @movement.category, date: @movement.date, description: @movement.description, value: @movement.value } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { category: @movement.category, date: @movement.date, description: @movement.description, value: @movement.value } }
